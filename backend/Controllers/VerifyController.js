...
verifyController.verify = function(req,res){
  ...
  let transpoter = nodemailer.createTransport({
    ...
    let mailOptions ={
      ...
      text: "IT works",
      html:
      "Welcome to Med-Tech.Please click on Link to set new Password<br><a href=http://localhost:3010/"+userInfo+"?token="+token+" target='_blank'>http://localhost:3010/doc?token="+token+"</a>"  
    }
